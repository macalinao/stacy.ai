...
const handlers = [

  {
    ...
    handler: async(session, msg) => {
      ...
      return {
        msg: `Cool, let's plan your trip to ${city}! We've found your local airport at BOS and the airport you're traveling to at ${session.destairport}. When do you want to travel?`,
        session
      };
    }
  },
  ...
  },
  {
    ...
    handler: async(session, msg) => {
      ...
      if (hotel) {
        return {
          msg: `You can stay at ` + hotel.name + ` in ` + city,
          hotel
        };
      }else {
        return {
